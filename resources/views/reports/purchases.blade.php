...
<div class="container mt-5" style="background-color:#f5ebe0">
    <div class="text-center mb-4">
        <h1 class="fw-bold text-dark">📉 Purchase Report</h1>
        <p class="text-secondary fs-5">Analyze purchases within a selected date range.</p>
    </div>
                ...
                <table class="table table-hover table-striped align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fs-5 text-primary">₹{{ number_format($purchase->total_amount, 2) }}</td>
