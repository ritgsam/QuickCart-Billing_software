...
//             $table->string('sku', 255)->after('stock')->nullable();
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('products')) {
            Schema::create('products', function (Blueprint $table) {
                ...
                $table->integer('stock_quantity')->default(0);
                $table->decimal('gst_amount', 10, 2)->nullable();
                $table->decimal('gst_rate', 5, 2)->default(0); // Ensuring GST Rate exists
                $table->decimal('discount', 5, 2)->default(0); // Ensuring Discount exists
                $table->decimal('tax_rate', 5, 2)->default(0);
                $table->string('hsn_code')->nullable();
                $table->boolean('visibility')->default(true);
                $table->string('sku', 255)->nullable();
